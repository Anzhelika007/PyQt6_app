...
3. Затем получаем файл .py конвертации верстки из .ui файла (название файла куда конвертируем в документации ui_imagedialog.py)
   (Примечание: есть и другой способ с uic без компиляции, сразу файл создать и взаимодействовать через класс, но если мы использовали иконки то их нужно компилировать)
...
Ветка SQLite
1. Создали файл > импортировали модуль > через конструкцию with as создали и заполнили базу
2. Создали класс взаимодействия